 ...
 *
 * Before this guard, two aliases collided in the registry and the LAST entry in
 ...
 *
 * Note: this fork does not register the "qwen-web" provider, so only the
 * "kimi"/"hc" collisions apply here (vs. the upstream three-way fix).
 */
